...
Since I use iTerm 2 profiles to `ssh` to my servers (See [Fast SSH Windows with iTerm 2](http://www.hiltmon.com/blog/2013/07/18/fast-ssh-windows-with-iterm-2/)), the simple `nohup ... &` version is the one I use all the time to kick off and log long-running UNIX commands.
